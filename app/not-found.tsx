	...
	return (
		<div className="flex flex-col items-center justify-center max-w-2xl gap-8 p-4 mx-auto text-white h-dvh w-dvw">
			<div className="flex flex-col w-full gap-2">
				...
				<Link
					href="/"
					className="flex flex-row items-center justify-center gap-2 text-2xl font-bold group hover:text-brand-yellow text-brand-blue w-fit"
				>
					<span className="group-hover:bg-squiggle">Return to safety</span>
					<FontAwesomeIcon icon={faArrowRight} />
				</Link>
			</div>
			<div className="text-brand-red animate-pulse text-[8rem] sm:text-[20rem] flex flex-row gap-4 justify-center flex-wrap">
