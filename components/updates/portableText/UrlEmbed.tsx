...
export default function UrlEmbedLoader({ url, overrideTitle }: Props) {
	return (
		<Link
			href={url}
			target="_blank"
			className="flex flex-col justify-center gap-4 my-4 overflow-hidden transition-colors border rounded-lg hover:border-zinc-500 outline-offset-2 group embed border-zinc-900 bg-zinc-950/75"
		>
