...
export default async function RatingsSpotify() {
	...
	return (
		<a
			className="flex flex-row items-center px-2 py-1 text-xs font-bold leading-normal text-white rounded-lg outline-zinc-300 outline-dashed whitespace-nowrap bg-spotify"
